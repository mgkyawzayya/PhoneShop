                ...
                <div class="card-body">
                  <form action="{{ url('service/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Enter Customer Name</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Enter Phone Model</label>
                          <input type="text" name="{{ $service->model }}" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="{{  $service->description }}" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="{{ $service->price }}" class="form-control">
                        </div>
                      </div>
                    </div>
